      ...
      <Grid>
        ...
        <Row className="home-menu-div show-grid text-center">
          ...
          <Col className="home-menu" xs={2} md={2}>
            ...
            <Button className="home-menu-button" bsStyle="default" onClick={() => this.props.changeCat('PTS', 'Points Leaders')} >Search Now</Button>
          </Col>
          <Col className="home-menu" xs={2} md={2}>
            <Image src="assets/snash250.jpg" className="" />
            <p className="img-text">Leaders by Assists</p>
            <Button className="home-menu-button" bsStyle="default" onClick={() => this.props.changeCat('AST', 'Assist Leaders')} >Search Now</Button>
          </Col>
          <Col className="home-menu" xs={2} md={2}>
            <Image src="assets/br250.jpg" className="" />
            <p className="img-text">Leaders by Blocks</p>
            <Button className="home-menu-button" bsStyle="default" onClick={() => this.props.changeCat('BlK', 'Block Leaders')} >Search Now</Button>
          </Col>
          <Col className="home-menu" xs={2} md={2}>
            <Image src="assets/dr250.jpg" className="" />
            <p className="img-text">Leaders by Rebounds</p>
            <Button className="home-menu-button" bsStyle="default" onClick={() => this.props.changeCat('REB', 'Rebound Leaders')} >Search Now</Button>
          </Col>
          <Col className="home-menu" xs={2} md={2}>
            <Image src="assets/lbj250.jpg" className="" />
            <p className="img-text">Leaders by Efficiency</p>
            <Button className="home-menu-button" bsStyle="default" onClick={() => this.props.changeCat('EFF', 'Efficiency Leaders')} >Search Now</Button>
          </Col>
          <Col xs={2} md={2}></Col>
        </Row>    
      </Grid>
